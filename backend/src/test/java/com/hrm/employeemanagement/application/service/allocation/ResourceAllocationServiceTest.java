...
class ResourceAllocationServiceTest {
        ...
        void testTC01_Success_AllocationDeductsRemainingCapacity() {
                ...
                WeeklyAvailability availability = new WeeklyAvailability(1L, employeeId, yearWeek, 40, 0,
                                BigDecimal.valueOf(10), BigDecimal.valueOf(30));
                when(loadWeeklyAvailabilityPort.findByEmployeeIdAndYearWeek(employeeId, yearWeek))
                                .thenReturn(Optional.of(availability));

                WeeklyProjectAllocation savedAllocation = WeeklyProjectAllocation.createNew(employeeId, projectId,
                                yearWeek, BigDecimal.valueOf(20));
                ...
                AllocateResourceCommand command = new AllocateResourceCommand(employeeId, projectId, year, weekNumber,
        ...
        void testAllocationExceedingCapacity_ThrowsAllocationCapacityExceededException() {
                ...
                WeeklyProjectAllocation existingProjAllocation = new WeeklyProjectAllocation(1L, employeeId, 99L,
                                yearWeek, BigDecimal.valueOf(30), 0L);
                when(loadAllocationPort.loadAllocationsForEmployee(employeeId, yearWeek))
                                .thenReturn(List.of(existingProjAllocation));
        ...
        void testUpdateExistingAllocation_Success() {
                ...
                WeeklyProjectAllocation existingAllocation = new WeeklyProjectAllocation(1L, employeeId, projectId,
                                yearWeek, BigDecimal.valueOf(10), 0L);
                WeeklyProjectAllocation updatedAllocation = new WeeklyProjectAllocation(1L, employeeId, projectId,
                                yearWeek, BigDecimal.valueOf(20), 1L);
                when(loadAllocationPort.loadAllocationsForEmployee(employeeId, yearWeek))
        ...
        void testTC02_Exception_EmployeeContractExpired() {
                ...
                Employee employee = new Employee(
                                ...
                                "Tester", LocalDate.of(2025, 1, 1), LocalDate.of(2026, 8, 1), false, 40,
        ...
        void testGetWeeklyCapacities_Success_BatchLoading() {
                ...
                YearWeek yearWeek = YearWeek.of(year, weekNumber);
                when(loadWeeklyAvailabilityPort.findByEmployeeIdInAndYearWeek(List.of(employeeId), yearWeek))
                                .thenReturn(List.of());
                when(loadAllocationPort.loadAllocationsForEmployeesInWeekRange(List.of(employeeId), year, weekNumber,
                                weekNumber)).thenReturn(List.of());
        ...
        void testNCL06CN007_TC01_StandardWeek40Hours_Allocate50Percent() {
                ...
                WeeklyProjectAllocation savedAllocation = WeeklyProjectAllocation.createNew(
                                employeeId, projectId, yearWeek, BigDecimal.valueOf(20).setScale(2),
                ...
                verify(saveAllocationPort).save(argThat(alloc -> alloc.getAllocatedHours()
        ...
        void testNCL06CN007_TC02_HolidayWeek32Hours_Allocate50Percent() {
                ...
                WeeklyAvailability availability = new WeeklyAvailability(1L, employeeId, yearWeek, 40, 8,
                                BigDecimal.ZERO, BigDecimal.valueOf(32));
                when(loadWeeklyAvailabilityPort.findByEmployeeIdAndYearWeek(employeeId, yearWeek))
                                .thenReturn(Optional.of(availability));

                WeeklyProjectAllocation savedAllocation = WeeklyProjectAllocation.createNew(
                                employeeId, projectId, yearWeek, BigDecimal.valueOf(16).setScale(2),
                                BigDecimal.valueOf(50).setScale(2));
                when(saveAllocationPort.save(any(WeeklyProjectAllocation.class))).thenReturn(savedAllocation);
        ...
        void testNCL06CN007_TC04_AuditLogRecordedWithPercentage() {
                ...
                WeeklyProjectAllocation savedAllocation = new WeeklyProjectAllocation(
                                555L, employeeId, projectId, yearWeek, BigDecimal.valueOf(20).setScale(2),
                                BigDecimal.valueOf(50).setScale(2), 1L);
                when(saveAllocationPort.save(any(WeeklyProjectAllocation.class))).thenReturn(savedAllocation);
                ...
                verify(saveAuditLogPort).save(argThat(audit -> "RESOURCE_ALLOCATED".equals(audit.getAction()) &&
        ...
        void testNCL06CN007_QTN11_PercentageExceedsCapacity_ThrowsException() {
                ...
                when(loadAllocationPort.loadAllocationsForEmployee(employeeId, yearWeek))
                                .thenReturn(List.of(otherProjectAlloc));

                // Yêu cầu phân bổ thêm 50% (20h) cho dự án projectId (10L) -> 25h + 20h = 45h >
                // 40h
                AllocateResourceCommand command = new AllocateResourceCommand(
                                employeeId, projectId, year, weekNumber, null, BigDecimal.valueOf(50));
