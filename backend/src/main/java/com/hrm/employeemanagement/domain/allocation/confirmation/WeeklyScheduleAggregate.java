 ...
 * 3. confirmationStatus tuân thủ quy tắc đánh giá của domain policy.
 */
public class WeeklyScheduleAggregate {
    ...
    public WeeklyScheduleAggregate(
        ...
        this.confirmationStatus = ScheduleConfirmationPolicy.determineConfirmationStatus(confirmedAt, maxUpdatedAt);
    }
