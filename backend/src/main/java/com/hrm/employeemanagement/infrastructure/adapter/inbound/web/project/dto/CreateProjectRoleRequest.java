...
public record CreateProjectRoleRequest(
        @NotBlank(message = "Mã vai trò chuyên môn không được để trống")
        @Size(max = 50, message = "Mã vai trò chuyên môn tối đa 50 ký tự")
        String code,
    ...
    public CreateProjectRoleCommand toCommand() {
        return new CreateProjectRoleCommand(code, name, description, skillGroupId);
    }
}
