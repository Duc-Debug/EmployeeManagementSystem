...
/**
 * NCL-05-CN-003: Xử lý phê duyệt đơn xin nghỉ phép (TC-01, TC-03, TC-04).
 */
public class ApproveLeaveRequestService implements ApproveLeaveRequestUseCase {
    ...
    public LeaveRequestResult approveLeaveRequest(Long leaveRequestId, String approverComment) {
        ...
        // 3. Thực thi nghiệp vụ domain: chuyển trạng thái sang APPROVED, lưu người duyệt
        ...
        // Khi chuyển sang APPROVED, hệ thống tự động trừ giờ khả dụng tuần theo QTN-10
