...
public class RecruitmentDemandReportService implements GetRecruitmentDemandReportUseCase {
    ...
    public RecruitmentDemandReportResult execute(RecruitmentDemandReportQuery query) {
        ...
        recordSuccessAuditLog(currentUserId, effectiveQuery, deficitCount, totalDeficitHours);
    ...
    private void recordSuccessAuditLog(Long userId, RecruitmentDemandReportQuery query, int deficitCount, BigDecimal totalDeficitHours) {
        String detail = String.format(
                ...
                query.orgUnitId() != null ? query.orgUnitId() : "Tất cả",
                deficitCount,
