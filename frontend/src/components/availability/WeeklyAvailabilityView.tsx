  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">
            {isSelfOnly ? "Giờ khả dụng của tôi" : "Quản lý Giờ khả dụng theo tuần"}
          </h1>
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-slate-200/90 bg-white p-4 shadow-xs sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Search Input (Only for managers who view multiple employees) */}
        {!isSelfOnly && (
      ...
      {/* Main Table: Only shown for managers who manage multiple employees */}
      {!isSelfOnly && (
