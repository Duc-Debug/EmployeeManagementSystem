...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, Record<string, ModulePermission>> = {
    ...
    "VT-02": {
        ...
        availability: { moduleId: "availability", moduleName: "Giờ khả dụng", scope: { type: "personal" }, actions: { view: true, create: false, edit: false, delete: false, approve: false, export: false } },
        calendar: { moduleId: "calendar", moduleName: "Lịch & Ngày lễ", scope: { type: "all" }, actions: { view: true, create: false, edit: false, delete: false, approve: false, export: false } },
    ...
    "VT-03": {
        ...
        projects: { moduleId: "projects", moduleName: "Quản lý dự án & WBS", scope: { type: "department_managed" }, actions: { view: true, create: false, edit: true, delete: false, approve: false, export: false } },
        ...
        availability: { moduleId: "availability", moduleName: "Giờ khả dụng", scope: { type: "department_managed" }, actions: { view: true, create: false, edit: false, delete: false, approve: false, export: true } },
        calendar: { moduleId: "calendar", moduleName: "Lịch & Ngày lễ", scope: { type: "all" }, actions: { view: true, create: false, edit: false, delete: false, approve: false, export: false } },
    ...
    "VT-05": {
        ...
        availability: { moduleId: "availability", moduleName: "Giờ khả dụng", scope: { type: "all" }, actions: { view: true, create: true, edit: true, delete: false, approve: false, export: true } },
